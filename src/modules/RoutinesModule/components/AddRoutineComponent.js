 ...
 */
  ...
  return (
    <div className={style.main}>
      {formData.submitted && routinesState.addRoutine.success && <Redirect to='/my-routines'></Redirect>}
      <h1 className={style.createRoutine__title}>Crear Rutina</h1>
